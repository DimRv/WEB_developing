...
try:
    b1 = bytes("Привет!", 'ascii', 'strict')
except UnicodeEncodeError:
    b1 = 'Ошибка при создании байтовой строки'
print(b1)  # Ошибка при создании байтовой строки

b2 = bytes("Привет!", 'ascii', 'ignore')
print(b2)  # b'!'
b3 = bytes("Привет!", 'ascii', 'replace')
print(b3)  # b'??????!'
b4 = bytes("Привет!", 'ascii', 'xmlcharrefreplace')
print(b4)  # b'&#1055;&#1088;&#1080;&#1074;&#1077;&#1090;!'
b3 = bytes("Привет!", 'ascii', 'backslashreplace')
print(b3)  # b'\\u041f\\u0440\\u0438\\u0432\\u0435\\u0442!'
b3 = bytes("Привет!", 'ascii', 'namereplace')
